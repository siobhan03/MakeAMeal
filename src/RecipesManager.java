...
public class RecipesManager {
    ...
    //Method to display and manage greek recipes
    public void greek() {
        ...
        //Read users choice and output accordingly
    ...
    //Method to display and manage italian recipes
    public void italian() {
    ...
    //Method to display and manage korean recipes
    public void korean() {
    ...
    //Method to display and manage mexican recipes
    public void mexican() {
    ...
    //Method to display and manage thai recipes
    public void thai() {
